...
public class InvertedTwoBlockWall implements EntityBase , Collidable{
...
//        }
        ...
        public static InvertedTwoBlockWall Create(){
            InvertedTwoBlockWall result = new InvertedTwoBlockWall();
            EntityManager.Instance.AddEntity(result, EntityBase.ENTITY_TYPE.ENT_SMURF);
            return result;
        }
        public static InvertedTwoBlockWall CreateNew(int xPos, int yPos)
        {
            InvertedTwoBlockWall result = new InvertedTwoBlockWall();
            result.xPos = xPos;
            result.yPos = yPos;
